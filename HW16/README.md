...
### Purpose:
The purpose of this analysis is using the spark dataframe functions to analyze whether the Amazon Vine program is a help for rating system.
